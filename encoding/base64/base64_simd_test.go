...
import (
	...
	base64 "github.com/zchee/go-benchmarks/encoding/base64/go-base64"
)
...
var funnyEncoding = base64.NewEncoding(base64.EncodeStd).WithPadding(rune('@'))
...
var encodingTests = []encodingTest{
	{base64.StdEncoding, stdRef},
	{base64.URLEncoding, urlRef},
	{base64.RawStdEncoding, rawRef},
	{base64.RawURLEncoding, rawURLRef},
...
func TestEncoder(t *testing.T) {
	t.Skip("not implements NewEncoder")
...
func TestDecode(t *testing.T) {
	t.Skip("Decode wrong implemented yet")
...
func TestDecoder(t *testing.T) {
	t.Skip("not implements NewDecoder")

	for _, p := range pairs {
		decoder := base64.NewDecoder(base64.StdEncoding, strings.NewReader(p.encoded))
		dbuf := make([]byte, base64.StdEncoding.DecodedLen(len(p.encoded)))
...
func TestDecoderBuffering(t *testing.T) {
	...
	for bs := 1; bs <= 12; bs++ {
		decoder := base64.NewDecoder(base64.StdEncoding, strings.NewReader(bigtest.encoded))
...
func TestDecodeCorrupt(t *testing.T) {
	...
	for _, tc := range testCases {
		dbuf := make([]byte, base64.StdEncoding.DecodedLen(len(tc.input)))
		_, err := base64.StdEncoding.Decode(dbuf, []byte(tc.input))
		if tc.offset == -1 {
			if err != nil {
...
func TestEncodedLen(t *testing.T) {
	for _, tt := range []struct {
		...
		{base64.RawStdEncoding, 0, 0},
		{base64.RawStdEncoding, 1, 2},
		{base64.RawStdEncoding, 2, 3},
		{base64.RawStdEncoding, 3, 4},
		{base64.RawStdEncoding, 7, 10},
		{base64.StdEncoding, 0, 0},
		{base64.StdEncoding, 1, 4},
		{base64.StdEncoding, 2, 4},
		{base64.StdEncoding, 3, 4},
		{base64.StdEncoding, 4, 8},
		{base64.StdEncoding, 7, 12},
	} {
...
func TestDecodedLen(t *testing.T) {
	t.Skip("DecodedLen wrong implemented yet")
	...
	for _, tt := range []struct {
		...
		{base64.RawStdEncoding, 0, 0},
		{base64.RawStdEncoding, 2, 1},
		{base64.RawStdEncoding, 3, 2},
		{base64.RawStdEncoding, 4, 3},
		{base64.RawStdEncoding, 10, 7},
		{base64.StdEncoding, 0, 0},
		{base64.StdEncoding, 4, 3},
		{base64.StdEncoding, 8, 6},
	} {
...
func TestBig(t *testing.T) {
	...
	decoded, err := io.ReadAll(base64.NewDecoder(base64.StdEncoding, encoded))
	if err != nil {
...
func TestNewLineCharacters(t *testing.T) {
	t.Skip("DecodeString wrong implemented yet")
...
`
	...
	dec = base64.NewDecoder(base64.StdEncoding, strings.NewReader(encodedShort))
	var res2 []byte
...
func TestDecoderIssue7733(t *testing.T) {
	...
	s, err := base64.StdEncoding.DecodeString("YWJjZA=====")
	want := base64.CorruptInputError(8)
...
func TestDecoderIssue15656(t *testing.T) {
	...
	_, err := base64.StdEncoding.Strict().DecodeString("WvLTlMrX9NpYDQlEIFlnDB==")
	want := base64.CorruptInputError(22)
	if !reflect.DeepEqual(want, err) {
		t.Errorf("Error = %v; want CorruptInputError(22)", err)
	}
	_, err = base64.StdEncoding.Strict().DecodeString("WvLTlMrX9NpYDQlEIFlnDA==")
	if err != nil {
		t.Errorf("Error = %v; want nil", err)
	}
	_, err = base64.StdEncoding.DecodeString("WvLTlMrX9NpYDQlEIFlnDB==")
	if err != nil {
		t.Errorf("Error = %v; want nil", err)
	}
}
...
func TestDecoderRaw(t *testing.T) {
	...
	// Direct.
	dec1, err := base64.RawURLEncoding.DecodeString(source)
	...
	r := base64.NewDecoder(base64.RawURLEncoding, bytes.NewReader([]byte(source)))
	...
	r = base64.NewDecoder(base64.URLEncoding, bytes.NewReader([]byte(source+"==")))
